...
function listCategories(request, response, url, todos, categories, users) {
...
function deleteCategory(request, response, url, todos, categories, users, writeCATEGORYtoFile) {
  if(url.query.id){
      for(let i=0; i<categories.length; i++){
...
function updateCategory(request, response, url, todos, categories, users, writeCATEGORYtoFile) {
  if(url.query.id){
    for(let i=0; i<categories.length; i++) {
