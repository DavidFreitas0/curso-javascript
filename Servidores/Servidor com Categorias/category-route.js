...
function deleteCategory(request, response, url, todos, categories) {
  if(url.query.id){
      for(let i=0; i<categories.length; i++){
...
function updateCategory(request, response, url, todos, categories) {
  if(url.query.id){
    for(let i=0; i<categories.length; i++) {
