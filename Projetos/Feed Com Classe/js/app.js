    ...
    constructor(){
        ...
        post(){
            for(let i = 0; i<this.posts.length; i++){
                ...
                perfil.src =this.posts[i].autor.photo;
                perfil.className = "perfil";
                username.innerText = "@" + this.posts[i].autor.username;
                username.className = "username";
                photo.src = this.posts[i].photo;
                photo.className ="foto";
                description.innerText = this.posts[i].description;
                description.className = "description";
                data.innerText = "Horário da Publicação : " + new Date(this.posts[i].timesTamp*1000).toLocaleTimeString("pt-BR");
                data.className = "data";
